...
!function(e, t) {
    ...
    return function(e) {
        ...
        var r = n(1), i = o(r), s = n(13), a = o(s);
        (0, a["default"])(), window.MutationObserver = window.WebKitMutationObserver = window.File = void 0, 
        window.WeixinJSBridge = i["default"];
    }, function(e, t, n) {
        function o(e) {
            return e && e.__esModule ? e :{
                "default":e
        ...
        function r(e) {
            ...
            if ("WINDOW_GET_WEBAPP_ERROR" === t) {
                ...
                return console.group("%c加载 " + r + " 错误", "color: red; font-size: x-large"), console.error("%c" + i, "color: red; font-size: x-large"), 
            ...
            }); else if ("WRITE_APP_DATA" === t) for (var c in n) {
                var p = n[c], v = p.__webviewId__;
        ...
        var i = n(2), s = o(i), a = n(4), u = (o(a), n(3)), f = o(u), l = n(5), d = o(l), c = n(7), p = o(c), v = n(8), g = o(v), h = n(9), _ = o(h), m = n(11), w = o(m);
        ...
        window.showDebugInfo = function(e, t) {
            ...
            console.group("showDebugInfo"), n.forEach(function(e) {
                console.group(e.timesmap + " WeixinJSBridge " + e.type + " " + e.eventName), console.debug.apply(window, e.data), 
                console.groupEnd();
        ...
        var r = n(2), i = (o(r), __wxConfig.apphash), s = __wxConfig.appid, a = __wxConfig.appname, u = navigator.userAgent, f = parseInt(u.match(/webview\/(\d*)/)[1]), l = [], d = [], c = function() {
            for (var e in d) d[e].apply(this, arguments);
        }, p = function(e) {
            d.push(e);
        }, v = function(e) {
            var t = JSON.parse(JSON.stringify(e));
            t.to = "backgroundjs", t.comefrom = "webframe", t.command = "COMMAND_FROM_ASJS", 
            t.appid = s, t.appname = a, t.apphash = i, t.webviewID = f, window.postMessage(t, "*");
        }, g = function(e) {
        ...
        var r = {
            ...
            return !(!n() || !r.hasOwnProperty(e)) && (console.warn("请注意无 AppID 关联下，调用 wx." + e + " 是受限的, API 的返回是工具的模拟返回"), 
            setTimeout(function() {
                r[e].apply(t, o);
            }), !0);
        };
        ...
        n.defaultMaxListeners = 10, n.prototype.setMaxListeners = function(e) {
            ...
            } else if (i(n)) for (a = Array.prototype.slice.call(arguments, 1), f = n.slice(), 
            r = f.length, u = 0; u < r; u++) f[u].apply(this, a);
            return !0;
            ...
            i(this._events[e]) && !this._events[e].warned && (r = s(this._maxListeners) ? n.defaultMaxListeners :this._maxListeners, 
            r && r > 0 && this._events[e].length > r && (this._events[e].warned = !0, console.error("(node) warning: possible EventEmitter memory leak detected. %d listeners added. Use emitter.setMaxListeners() to increase limit.", this._events[e].length), 
            ...
            if (n = this._events[e], s = n.length, r = -1, n === t || o(n.listener) && n.listener === t) delete this._events[e], 
        ...
        function r(e, t) {
            s["default"].debugLog(new Date() + " WeixinJSBridge on " + e, arguments), s["default"].debugInfo({
                ...
                data:arguments,
                timesmap:new Date()
            }), "onAppEnterForeground" === e && (l.onAppShow || (t && t({}), l.onAppShow = !0)), 
            f.hasOwnProperty(e) && t && f[e].push(t);
        }
        Object.defineProperty(t, "__esModule", {
            value:!0
        }), t["default"] = r;
        var i = n(2), s = o(i), a = n(5), u = o(a), f = {
            onSocketOpen:[],
            onSocketError:[],
            onSocketMessage:[],
            onSocketClose:[],
        ...
        function r(e, t, n, o) {
            if (s["default"].debugLog(new Date() + " WeixinJSBridge publish " + e, arguments), 
            t && 0 !== e.indexOf("canvas")) {
        ...
        var i = n(2), s = o(i), a = n(3), u = o(a), f = n(10);
    }, function(e, t) {
        Object.defineProperty(t, "__esModule", {
            value:!0
        });
        ...
        }, __wxConfig), o = t.projectConfig = n.projectConfig || {};
        t.MaxRequestConcurrent = o.Setting && o.Setting.MaxRequestConcurrent || 5, t.NetworkConfig = o && o.Network || {}, 
        t.AppserviceMaxDataSize = __wxConfig.appserviceConfig.AppserviceMaxDataSize;
    }, function(e, t, n) {
        function o(e) {
            return e && e.__esModule ? e :{
                "default":e
        ...
        function s(e, t, n) {
            if (u["default"].debugLog(new Date() + " WeixinJSBridge invoke " + e, arguments), 
            !l["default"].check.apply(this, arguments)) if (u["default"].debugInfo({
                type:"invoke",
                eventName:e,
                data:arguments,
                timesmap:new Date()
            }), m.hasOwnProperty(e)) m[e].apply(this, arguments); else {
                var o = r(), i = function(t) {
                    if (t.errMsg.indexOf("ok") > -1 && ("navigateTo" === e || "redirectTo" === e)) {
                        var o = t.url || "", r = o.match(/(([^\?]*)(\?([^\/]*))?)$/), i = "", s = {};
                        if (r) {
                            i = r[2] || "";
        ...
        var a = n(2), u = o(a), f = n(4), l = o(f), d = n(5), c = o(d), p = n(3), v = o(p), g = n(12), h = o(g), _ = {};
        ...
        function r(e, t) {
            if (u["default"].isTourist()) return console.warn("请注意无 AppID 关联下，工具未检查安全域名，更多请参考文档-API-网络"), 
            !0;
            try {
                for (var n = "webscoket" === t ? f.NetworkConfig.WsRequestDomain :f.NetworkConfig.RequestDomain, o = 0; o < n.length; o++) if (0 === e.indexOf(n[o])) return !0;
            } catch (r) {
        ...
        var i = n(5), s = o(i), a = n(4), u = o(a), f = n(10), l = null, d = 0, c = function(e, t, n) {
            if (d++, d > f.MaxRequestConcurrent) return d--, console.error("%c 最多同时发起 " + f.MaxRequestConcurrent + " 个 wx.request 请求", "color: red; font-size: x-large"), 
            void (n && n({
                errMsg:"request:fail;"
            }));
            ...
            //if (!r(o)) 
            if (false)
                return d--, console.error("%c URL 域名不合法，请在 mp 后台配置后重试", "color: red; font-size: x-large"), 
            void (n && n({
                errMsg:"request:fail;"
            }));
            var s, a = new XMLHttpRequest(), u = t.method || "POST", l = (t.complete, f.appconfig.networkTimeout && f.appconfig.networkTimeout.request);
            a.open(u, t.url, !0), a.onreadystatechange = function() {
            ...
            "POST" != u || c || a.setRequestHeader("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8"), 
            a.setRequestHeader("X-Requested-With", "XMLHttpRequest"), "number" == typeof l && (s = setTimeout(function() {
