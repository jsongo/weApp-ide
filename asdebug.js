...
!function() {
    ...
    function a(o) {
        ...
        if ("WINDOW_GET_WEBAPP_ERROR" === n) {
            var a = r.fileName
              , i = r.errStr;
            return console.group("%c加载 " + a + " 错误", "color: red; font-size: x-large"),
            console.error("%c" + i, "color: red; font-size: x-large"),
            void console.groupEnd()
        }
        if ("MSG_FROM_WEBVIEW" === n || "GET_ASSDK_RES" === n) {
            var s = r.eventName || t.sdkName;
            J && (console.group(new Date + " GetMsg " + s),
            console.debug(s, r, t),
            console.groupEnd()),
            P.push({
                type: "GetMsg",
        ...
        if ("MSG_FROM_WEBVIEW" === n) {
            var c = r.eventName
              , u = r.type
              , p = r.data || {};
            p.webviewId = r.webviewID,
            "ON_APPLIFECYCLE_EVENT" === u ? S(c, p) : "ON_MUSIC_EVENT" === u && A(c, p),
            WeixinJSBridge._subscribe[c] && WeixinJSBridge._subscribe[c](p, p.webviewId)
        } else if ("GET_ASSDK_RES" === n) {
            var d = t.callbackID;
            z[d](r),
            delete z[d]
        } else if ("GET_APP_DATA" === n)
            e({
                appData: __wxAppData,
    ...
    function i(e, o) {
        if (O)
            return console.warn("请注意无 AppID 关联下，工具未检查安全域名，更多请参考文档-API-网络"),
            !0;
        try {
    ...
    function s(e, o, n) {
        ...
        var a, s = new XMLHttpRequest, c = o.method || "POST", u = (o.complete,
        G.networkTimeout && G.networkTimeout.request);
        s.open(c, o.url, !0),
        ...
        for (var d in t)
            if (t.hasOwnProperty(d)) {
                var l = d.toLowerCase();
                p = "content-type" == l || p,
                "cookie" === l ? s.setRequestHeader("_Cookie", t[d]) : s.setRequestHeader(d, t[d])
            }
        "POST" != c || p || s.setRequestHeader("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8"),
        s.setRequestHeader("X-Requested-With", "XMLHttpRequest"),
        "number" == typeof u && (a = setTimeout(function() {
            s.abort("timeout"),
    ...
    var B, J = !1, P = [], q = navigator.userAgent, L = parseInt(q.match(/webview\/(\d*)/)[1]), F = [], z = {} 
        ...
        , H = 0, V = __wxConfig.appserviceConfig.AppserviceMaxDataSize;
    try {
    ...
    window._____sendMsgToNW = e,
    window.addEventListener("message", function(e) {
        var o = e.data
          , n = o.to;
        if ("appservice" === n)
            return delete n.appservice,
            "complete" !== document.readyState ? void F.push(o) : void a(o)
    }),
    ...
    WeixinJSBridge._subscribe = {},
    WeixinJSBridge.subscribe = function(e, o) {
        J && (console.group(new Date + " WeixinJSBridge subscribe"),
        console.debug(e, o),
        console.groupEnd()),
        P.push({
            type: "subscribe",
    ...
    WeixinJSBridge.publish = function(o, n, r, t) {
        if (J && (console.group(new Date + " WeixinJSBridge publish " + o),
        console.debug(o, n, r, t),
        console.groupEnd()),
        n && 0 !== o.indexOf("canvas")) {
            var a = JSON.stringify(n)
              , i = a.length;
            if (i > V)
                return void console.error("%c " + o + " 数据传输长度为 " + i + " 已经超过最大长度 " + V, "color: red; font-size: x-large")
        }
        P.push({
            type: "publish",
            eventName: o,
    ...
    WeixinJSBridge.invoke = function(e, o, n) {
        return J && (console.group(new Date + " WeixinJSBridge invoke " + e),
        console.debug(e, o, n),
        console.groupEnd()),
        O && j[e] ? (console.warn("请注意无 AppID 关联下，调用 wx." + e + " 是受限的, API 的返回是工具的模拟返回"),
    ...
    WeixinJSBridge.on = function(e, o) {
        J && (console.group(new Date + " WeixinJSBridge on " + e),
        console.debug(e, o),
        console.groupEnd()),
        P.push({
            type: "on",
    ...
    window.showDebugInfo = function(e, o) {
        var n = P.filter(function(n) {
            var r = !e || (Array.isArray(e) ? e.includes(n.type) : n.type === e)
              , t = !o || (Array.isArray(o) ? o.includes(n.eventName) : n.eventName === o);
            if (r && t)
                return n
        });
        console.group("showDebugInfo"),
        n.forEach(function(e) {
            console.group(e.timesmap + " WeixinJSBridge " + e.type + " " + e.eventName),
