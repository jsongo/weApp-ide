...
function init() {
    ...
    var t = require("../../lib/react.js"), a = (require("../../utils/tools.js"), require("../../cssStr/cssStr.js")), r = require("path"), i = require("../../utils/newReport.js"), s = require("../../config/urlConfig.js"), o = require("../../common/request/request.js"), c = (require("../../stores/webviewStores.js"), 
    require("../../common/log/log.js")), n = require("glob"), p = require("../../config/errcodeConfig.js"), l = (require("../../actions/windowActions.js"), 
    require("../../stores/projectStores.js")), m = require("../../actions/projectActions.js"), d = ".wxwx", u = "touristappid", h = t.createClass({
        ...
        chooseDir:function() {
            ...
            t.setAttribute("type", "file"), t.setAttribute("nwdirectory", !0), t.style.display = "none", 
            global.contentDocumentBody.appendChild(t), t.addEventListener("change", function(a) {
                n("*", {
                    cwd:t.value
                }, function(a, i) {
                    var s = 0 === i.length;
                    e.setState({
                        projectpath:t.value,
                        showQuickStart:s,
                        verify:1 === i.length && r.extname(i[0]) === d
                    });
        ...
        addProject:function() {
            var t = this, a = this.state.projectpath, r = this.state.isTourist, n = r ? u :this.state.appid, d = encodeURIComponent(this.state.appname);
            if (!n) return void e("请填写 appid ");
            if (!d) return void e("请填写 项目名称 ");
            if (!a) return void e("请选择 项目目录 ");
            var h = n + "_" + d, f = this.props.projectLists.find(function(e) {
            ...
            if (f) return void this.setState({
                ...
                appname:"",
                saveBtnDisable:!0,
                error:"已存在 " + n + " " + decodeURIComponent(f.appname) + " 项目，请重新输入"
            });
            ...
            if (r) {
                ...
                m.add(j, v), i("project_createsuc", n), this.setState(g), this.props.goMain(j), 
                o({
                    url:s.touristCreateURL + "?appid=" + n,
                    needToken:1
                });
            } else o({
                ...
                if (r) c.error("createstep.js create  " + r.toString()), t.setState({
                    ...
                    t.setState({
                        showLoading:!1
                    }), c.info("createstep.js create  " + o);
                    //var u = JSON.parse(o), j = u.baseresponse, b = j ? parseInt(j.errcode) :0;
                    var u = {
                        is_admin: true,
